...
namespace Graph.Business
{
    ...
    public static class GraphBusiness
    {
        ...
        public static List<GraphRouteAlgorithmReturn> ComputeAllRoutes(GraphModel graph, char startNode, char endNode, int maxStops)
        {
            AllRoutesAlgorithm algorithm = new AllRoutesAlgorithm(graph, startNode, endNode, maxStops);

            return algorithm.ComputeAllRoutes();
        }
    }
}